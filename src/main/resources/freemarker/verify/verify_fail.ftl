                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                           ...
                           <tr>
                              <td>
                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td align="center" style="font-size: 25px; font-family: Roboto Condensed, Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding">Invalid member or verification token!</td>
                                    </tr>
                                 </table>
                              </td>
                           </tr>
