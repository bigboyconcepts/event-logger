 ...
 */
@Provider
public class AppModeParamConverterProvider implements ParamConverterProvider
{
    @Override
    public <T> ParamConverter<T> getConverter(Class<T> rawType, Type genericType, Annotation[] annotations)
    {
        return rawType == AppModeParam.class ? (ParamConverter<T>) new AppModeParamConverter() : null;
    }
}
