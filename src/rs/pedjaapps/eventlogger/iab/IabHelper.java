...
public class IabHelper {
    ...
    Inventory queryInventory(boolean querySkuDetails, List<String> moreSkus) throws IabException {
    ...
    void logError(String msg) {
        if(BuildConfig.DEBUG)Log.e(mDebugTag, "In-app billing error: " + msg);
    }

    void logWarn(String msg) {
        if(BuildConfig.DEBUG)Log.w(mDebugTag, "In-app billing warning: " + msg);
    }
